# 2026-09-22 18:19:18 by RouterOS 7.11.3
...
/ppp profile add local-address=10.10.15.1 name="PAKET TURBO" only-one=yes parent-queue=PAKET-5 queue-type=FQ-CODEL rate-limit="1000M/1000M 0/0 0/0 0/0 8 1000M/1000M" remote-address=paket5
...
/ip firewall filter add action=drop chain=input comment=BLOCK-SWEDEN-ATTACKER disabled=yes src-address=45.198.224.15
/ip firewall filter add action=drop chain=input comment=RESTRICT-API-WINBOX-LOCAL disabled=yes dst-port=8728,8291 protocol=tcp src-address=!10.0.0.0/8
/ip firewall filter add action=add-src-to-address-list address-list=ssh_blacklist address-list-timeout=10m chain=input comment=SSH-RATELIMIT connection-state=new disabled=yes dst-limit=3/1m,9,dst-address/1m dst-port=18 protocol=tcp src-address-list=!ssh_whitelist
/ip firewall filter add action=drop chain=input comment=DROP-SSH-BRUTE disabled=yes dst-port=18 protocol=tcp src-address-list=ssh_blacklist
...
/ip firewall nat add action=dst-nat chain=dstnat dst-port=3388 in-interface=SFP-LNS-LA protocol=tcp to-addresses=10.10.10.205 to-ports=3389
...
/ip hotspot ip-binding add address=10.10.10.50 comment="cctv kamera desa" to-address=10.10.10.50 type=bypassed
...
/ip route add check-gateway=ping comment=SPEEDTEST disabled=yes distance=1 dst-address=0.0.0.0/0 gateway=8.8.8.8 pref-src="" routing-table=SPEEDTEST scope=30 suppress-hw-offload=no target-scope=11
...
/ppp secret add disabled=yes name=230909151059-IMAS profile=PAKET1 service=pppoe
...
/ppp secret add disabled=yes name=210901143046-SENDUL profile=PAKET1 service=pppoe
...
/ppp secret add name=YOFI profile="PAKET TURBO" service=pppoe
/ppp secret add name=RUMAH profile="PAKET HEMAT" service=pppoe
...
/ppp secret add name=230114190808-SIDIK profile="PAKET PUAS" service=pppoe
...
/ppp secret add disabled=yes name=10300083-LIA profile=PAKET1 service=pppoe
...
/ppp secret add disabled=yes name=SAUNG profile=PAKET4 service=pppoe
...
/ppp secret add name=250302105822-ROBBY profile=PAKET1 service=pppoe
...
/ppp secret add name=250605111505-ERNI profile="PAKET HEMAT" service=pppoe
...
/ppp secret add name=250626210230-ADI profile=PAKET2 service=pppoe
/ppp secret add name=250701170714-WATI profile="PAKET HEMAT" service=pppoe
/ppp secret add name=250704095837-NENI profile="PAKET MANTAP" service=pppoe
...
/ppp secret add disabled=yes name=251104155759-KATINO profile="PAKET HEMAT" service=pppoe
...
/ppp secret add disabled=yes name=260131165910-AGUNG profile="PAKET HEMAT" service=pppoe
...
/ppp secret add disabled=yes name=260302144821-LALA profile="PAKET HEMAT" service=pppoe
...
/ppp secret add disabled=yes name=260330135611-LINA profile="PAKET HEMAT" service=pppoe
...
/ppp secret add disabled=yes name=260626175713-RAMDANI profile="PAKET HEMAT" service=pppoe
...
/ppp secret add name=260706120117-SRIHAYATI profile=PAKET2 service=pppoe
...
/ppp secret add disabled=yes name=230909151095-IPAN profile=PAKET1 service=pppoe
/ppp secret add name=260718133911-UDIN profile=PAKET3 service=pppoe
/ppp secret add name=260720173718-MERI profile="PAKET MANTAP" service=pppoe
/ppp secret add name=260724104446-CANDRA profile="PAKET MANTAP" service=pppoe
/ppp secret add name=260728180140-ANDI profile="PAKET HEMAT" service=pppoe
/ppp secret add name=260803140431-LISAN profile=PAKET3 service=pppoe
/ppp secret add name=260803165225-LINA profile="PAKET HEMAT" service=pppoe
/ppp secret add name=260804131051-WILI profile="PAKET PUAS" service=pppoe
/ppp secret add name=260807095335-RITA profile="PAKET HEMAT" service=pppoe
/ppp secret add name=260807181333-AAH profile="PAKET MANTAP" service=pppoe
/ppp secret add name=260809112434-HANI profile=PAKET3 service=pppoe
/ppp secret add disabled=yes name=260809123821-RESTI profile=PAKET2 service=pppoe
/ppp secret add name=260809150425-YUNITA profile="PAKET MANTAP" service=pppoe
/ppp secret add name=260810102754-KUSTIWA profile=PAKET3 service=pppoe
/ppp secret add name=260810151529-SEPTIAN profile="PAKET HEMAT" service=pppoe
/ppp secret add name=260814112503-AGUS profile="PAKET PUAS" service=pppoe
/ppp secret add name=260825152044-ASEP profile="PAKET MANTAP" service=pppoe
/ppp secret add name=260901213710-WINI profile="PAKET HEMAT" service=pppoe
/ppp secret add name=260905115421-EVI profile=PAKET3 service=pppoe
/ppp secret add name=260905151211-ASEP profile="PAKET PUAS" service=pppoe
/ppp secret add name=260906135157-SUCI profile="PAKET MANTAP" service=pppoe
/ppp secret add name=260906144949-ANDRIYANA profile="PAKET MANTAP" service=pppoe
/ppp secret add name=260909145419-HILAMAN profile=PAKET3 service=pppoe
/ppp secret add name=260911175513-SILVI profile="PAKET MANTAP" service=pppoe
/ppp secret add name=260912135352-DIKI profile="PAKET PUAS" service=pppoe
/ppp secret add name=260915155518-ENENG profile=PAKET3 service=pppoe
/ppp secret add name=260920125746-TEDI profile="PAKET MANTAP" service=pppoe
/ppp secret add name=260922155654-AYI profile="PAKET MANTAP" service=pppoe
/snmp set enabled=yes trap-generators=start-trap trap-version=2
/system clock set time-zone-name=Asia/Jakarta
/system identity set name=PUSAT
/system note set note=497 show-at-login=no
...
/system script add dont-require-permissions=no name=reset-pppoe-260619152230-SITI owner=keanu policy=ftp,reboot,read,write,policy,test,password,sniff,sensitive,romon source="/interface reset-counters <pppoe-260619152230-SITI>"
/system script add dont-require-permissions=no name=reset-pppoe-260627110040-ELSA owner=keanu policy=ftp,reboot,read,write,policy,test,password,sniff,sensitive,romon source="/interface reset-counters <pppoe-260627110040-ELSA>"
