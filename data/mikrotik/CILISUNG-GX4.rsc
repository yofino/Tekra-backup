# 2026-09-22 01:59:58 by RouterOS 7.16.1
...
/ip dns set allow-remote-requests=yes cache-max-ttl=1d cache-size=4096KiB servers=103.99.27.123,157.20.144.117
...
/ppp secret add name=11100105-DEFIANA profile="PAKET MANTAP" service=pppoe
...
/ppp secret add name=241220150933-FERDY profile="PAKET MANTAP" service=pppoe
...
/ppp secret add disabled=yes name=251209152000-AGUS profile="PAKET HEMAT" service=pppoe
...
/ppp secret add name=251225144806-NIDA profile="PAKET MANTAP" service=pppoe
...
/ppp secret add disabled=yes name=251229120809-MEGA profile="PAKET HEMAT" service=pppoe
...
/ppp secret add name=260501153341-NOER profile="PAKET PUAS" service=pppoe
...
/ppp secret add name=260803192447-NURHAYATI profile="PAKET MANTAP" service=pppoe
/ppp secret add name=260807141818-TOPAN profile="PAKET MANTAP" service=pppoe
/ppp secret add name=260830154803-SUSILAWATI profile="PAKET HEMAT" service=pppoe
/ppp secret add name=260830172701-TRIANDIKA profile=PAKET1 service=pppoe
/ppp secret add name=260901111637-EUTIK profile="PAKET MANTAP" service=pppoe
/ppp secret add name=260901113901-FANNY profile="PAKET HEMAT" service=pppoe
/ppp secret add name=260908121305-RESA profile="PAKET HEMAT" service=pppoe
/snmp set enabled=yes trap-version=3
/system clock set time-zone-name=Asia/Jakarta
/system identity set name=CILISUNG
/system note set note=184 show-at-login=no
